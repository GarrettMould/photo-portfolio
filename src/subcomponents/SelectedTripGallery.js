...
const SelectedTripGallery = (props) => { 
    ...
    <NewGridContainer gap={props.isMobile ? "1em" : "2em"} opacity={props.modalOpen ? "70%" : "100%"}>
        ...
        <GridItem gridColumnStart={6}  gridColumnEnd={8} gridRowStart={1} ><Image cursor={props.modalOpen ? "default" : "zoom-in"} maxWidth="100%" src={photos[20].src} onClick={props.handleImageSelect}></Image></GridItem> 
        <GridItem gridColumnStart={1} gridColumnEnd={5} gridRowStart={4} ><Image cursor={props.modalOpen ? "default" : "zoom-in"} maxWidth="100%" src={photos[12].src} onClick={props.handleImageSelect}></Image></GridItem> 
        <GridItem gridColumnStart={1} gridColumnEnd={2} gridRowStart={7} ><Image cursor={props.modalOpen ? "default" : "zoom-in"} maxWidth="100%" src={photos[13].src} onClick={props.handleImageSelect}></Image></GridItem>
        ...
        <GridItem gridColumnStart={1} gridColumnEnd={2} gridRowStart={10} ><Image cursor={props.modalOpen ? "default" : "zoom-in"} maxWidth="100%" src={photos[15].src} onClick={props.handleImageSelect}></Image></GridItem>
        <GridItem gridColumnStart={1} gridColumnEnd={8} gridRowStart={12} ><Image cursor={props.modalOpen ? "default" : "zoom-in"} maxWidth="100%" src={photos[29].src} onClick={props.handleImageSelect}></Image></GridItem> 
        <GridItem gridColumnStart={1} gridColumnEnd={8} gridRowStart={12} ><Image cursor={props.modalOpen ? "default" : "zoom-in"} maxWidth="100%" src={photos[29].src} onClick={props.handleImageSelect}></Image></GridItem> 
        ...
        <GridItem gridColumnStart={3} gridColumnEnd={6} gridRowStart={24} ><Image cursor={props.modalOpen ? "default" : "zoom-in"} maxWidth="100%" src={photos[30].src} onClick={props.handleImageSelect}></Image></GridItem> 
        ...
        <GridItem gridColumnStart={3} gridColumnEnd={8} gridRowStart={34} ><Image cursor={props.modalOpen ? "default" : "zoom-in"} maxWidth="100%" src={photos[19].src} onClick={props.handleImageSelect}></Image></GridItem>
